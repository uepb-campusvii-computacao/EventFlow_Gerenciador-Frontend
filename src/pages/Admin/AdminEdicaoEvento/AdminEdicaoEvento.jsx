...
const AdminEdicaoEvento = () => {
	...
	const editor = useEditor({
		...
		editorProps: {
			attributes: {
				class:
					'prose max-w-full text-black bg-zinc-50 rounded-b-lg p-2 focus:outline-none w-full max-h-[400px] overflow-y-scroll',
			},
		}
	});
	const {
    ...
    // }
		toast.info('Ainda não temos podemos enviar nada pessoal, em fase experimental hehehe')
